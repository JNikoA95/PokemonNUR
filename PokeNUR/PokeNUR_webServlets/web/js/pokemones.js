...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            localStorage.setItem("pokemoneslist", JSON.stringify(result));
        }
    });

    var elementos = JSON.parse(localStorage.getItem("pokemoneslist"));
...
$(document).on("click", ".mod", function() {
    ...
    var tuplas = JSON.parse(localStorage.getItem("pokemoneslist"));
    for (var k in tuplas) {
        var obj = tuplas[k];
...
$(document).on("click", ".del", function() {
 ...
 function save() {
        ...
        $.post('pokemones', {make: obj}, function(responseText) {
            if (responseText != -1) {
                ...
                if (operacion == 'A') {
                    ...
                    var elementos = JSON.parse(localStorage.getItem("pokemoneslist"));
                    elementos.push(item);
                    localStorage.setItem("pokemoneslist", JSON.stringify(elementos));                    
                } else {
