...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            localStorage.setItem("tipopokemonlist", JSON.stringify(result));
        }
    });

    var elementos = JSON.parse(localStorage.getItem("tipopokemonlist"));
...
$(document).on("click", ".mod", function() {
    ...
    var tuplas = JSON.parse(localStorage.getItem("tipopokemonlist"));
    for (var k in tuplas) {
        var obj = tuplas[k];
...
$(document).on("click", ".del", function() {
 ...
 function save() {
        ...
        $.post('tipopokemon', {make: obj}, function(responseText) {
            if (responseText != -1) {
                ...
                if (operacion == 'A') {
                    ...
                    var elementos = JSON.parse(localStorage.getItem("tipopokemonlist"));
                    elementos.push(item);
                    localStorage.setItem("tipopokemonlist", JSON.stringify(elementos));                    
                } else {
