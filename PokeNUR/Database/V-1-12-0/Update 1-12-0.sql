...
PRINT 'Actualizando a la version 1.12.0'
...
BEGIN
	...
	RAISERROR('La base de datos no esta en la version 1.11. Este script solamente se aplica a la version 1.11',16,127)
	RETURN;
...
/****** Object:  StoredProcedure [dbo].[upd_getDatosUsBatalla]    Script Date: 11/07/2017 18:21:50 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Author:		Isabel Bladerrama
-- Create date: <Create Date,,>
-- Description:	Cambia el estado de la batalla 
-- =============================================


CREATE PROCEDURE [dbo].[upd_getDatosUsBatalla]
