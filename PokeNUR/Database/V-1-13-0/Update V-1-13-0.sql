...
IF @intVersionMayor IS NULL OR @intVersionMenor IS NULL OR NOT (@intVersionMayor = 1 AND @intVersionMenor = 12 AND @intPatch = 0)
BEGIN
...
/****** Object:  StoredProcedure [dbo].[get_tblAtaquesByTipo]    Script Date: 11/07/2017 20:55:11 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[get_tblAtaquesByTipo]
	@prmTipo int
AS
BEGIN
