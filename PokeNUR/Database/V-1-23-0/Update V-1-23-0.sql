...
PRINT 'Actualizando a la version 1.23.0'
...
BEGIN
	...
	RAISERROR('La base de datos no esta en la version 1.22. Este script solamente se apllica a la version 1.22',16,127)
	RETURN;
...
-- =============================================
CREATE PROCEDURE get_tblPokemonAtaque 
