...
//  Seleccion de Pokemon Rutas...
        Route::post('seleccionPokemon', 'SeleccionController@seleccionar')->name('seleccionPokemon');
        Route::get('seleccionPokemon', 'SeleccionController@index')->name('seleccionPokemon');
